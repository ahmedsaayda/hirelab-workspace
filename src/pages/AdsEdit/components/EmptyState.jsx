    ...
    <div className="flex items-center justify-center h-full bg-[#f9fafb]">
      <div className="text-center max-w-md px-6">
        ...
        <button
          onClick={onGenerate}
          disabled={loading}
          className="px-6 py-3 bg-[#5207CD] hover:bg-[#0c76e5] text-white font-semibold text-base rounded-lg transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 mx-auto"
        >
          {loading ? (
            <>
        ...
        <div className="mt-6 flex items-start gap-2 text-left bg-[#eff8ff] p-4 rounded-lg">
          <svg className="w-5 h-5 text-[#5207CD] flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor">
