...
// Portrait aligns to Square positions/sizes for consistent layout
...
/**
 * Portrait (4:5) for Job Ad Variant 1.
 * This mirrors the Story V1 composition without the story header/chrome,
 * scaled to 1080x1350.
 */
export default function Variant1({ variant, brandData, landingPageData }) {
  ...
  // Title: two lines within 324px (dynamic sizing)
  ...
  return (
    ...
    >
      ...
      {/* Brand at top-left (match Square: x:80,y:80) */}
      <div
        style={{
          position: "absolute",
          top: "80px",
      ...
      {/* Accent block on the right (match Square: 905,302, 338x338) */}
      <div
        style={{
          position: "absolute",
          left: "905px",
      ...
      {/* Bottom content card (match Square proportions: x:0, y:764, 905x470) */}
      <div
        style={{
          position: "absolute",
          left: 0,
      ...
      >
        ...
        />
        {/* Ellipse glow same as Square coordinates inside card */}
        <div
          style={{
            position: "absolute",
            top: "-85px",
        ...
        <div style={{ position: "absolute", left: "80px", top: "64px", width: "324px", height: "198px" }}>
          <div style={{ display: "flex", alignItems: "center", height: "36px" }}>
            <span aria-hidden style={{ fontSize: "36px", lineHeight: 1, marginRight: "16px" }}>👋</span>
            <span
              style={{
                marginTop: "6px",
