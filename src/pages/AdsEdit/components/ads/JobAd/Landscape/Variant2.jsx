...
export default function Variant2({ variant, brandData, landingPageData }) {
  ...
  return (
    <div className="relative" style={{ width: "1080px", height: "1350px", backgroundColor: getPrimary(500), overflow: "hidden" }}>
      ...
      {/* Title + badges */}
      <div style={{ position: "absolute", left: "100px", top: "290px", width: "388px", display: "flex", flexDirection: "column", gap: "16px", zIndex: 2 }}>
      ...
      <div style={{ position: "absolute", left: "100px", top: "628px", width: "343px", display: "flex", flexDirection: "column", gap: "24px", zIndex: 2 }}>
        {[
      ...
      <button style={{ position: "absolute", left: "689px", top: "1107px", padding: "22px 48px", width: "295px", height: "82px", border: "none", borderRadius: "100px", backgroundColor: primaryColor, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", boxShadow: "0px 18px 35px rgba(39, 0, 133, 0.3)", zIndex: 2 }}>
