...
// import IconsSelector from "..."; const IconsSelector = () => <div>Icons Selector Placeholder</div>; const IconRenderer = () => <div>Icon Renderer Placeholder</div>;
  ...
  return (
    <div className="flex flex-col gap-4 w-full !text-blue_gray-700">
      ...
      <Button
        onClick={handleSave}
        loading={isSaving}
        className="mt-6 rounded-lg bg-[#5207CD] text-white hover:bg-[#0B6ECD]"
      >
