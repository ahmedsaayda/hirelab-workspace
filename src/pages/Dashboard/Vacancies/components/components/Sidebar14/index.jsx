...
export default function Sidebar14({ ...props }) {
  ...
  return (
    <Sidebar
      ...
      className={`${props.className} flex flex-col h-screen pt-[33px] gap-[30px] top-0 px-4 smx:pt-5 border-blue_gray-50 border-r border-solid bg-white-A700 !sticky overflow-auto mdx:hidden`}
    >
      ...
      >
        ...
        <MenuItem
          icon={
            <Img
              src="/images/img_calendar_light_blue_a700.svg"
              alt="calendar"
              className="h-[18px] w-[18px]"
            />
          }
