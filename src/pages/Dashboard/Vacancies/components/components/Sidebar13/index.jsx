...
export default function Sidebar13({ ...props }) {
  ...
  return (
    <Sidebar
      ...
      className={`${props.className} flex flex-col h-screen pt-[33px] gap-[30px] top-0 smx:pt-5 border-blue_gray-50 border-r border-solid bg-white-A700 !sticky overflow-auto mdx:hidden`}
    >
