...
const AiLoadingStateAnimation = ({
  ...
  const hiringFacts = [
    ...
    "Remote work increases employee retention by 13% and reduces employee stress by 71%.",
    "Only 15% of employees worldwide feel engaged at work, according to Gallup research.",
    "The average time to fill a position is 36 days across all industries.",
    "Glassdoor reviews influence 70% of job seekers' decisions about where to apply.",
    "Candidates are 4x more likely to consider your company if a current employee shared the opportunity.",
    "44% of professionals have experienced discrimination during the hiring process.",
    "Companies that test soft skills during hiring see 12% lower turnover rates.",
    "The most effective recruiting channel varies by industry: tech favors LinkedIn, while retail relies on job boards.",
    "87% of recruiters use LinkedIn to vet candidates during the hiring process.",
    "Only 2% of applicants who apply online get called for an interview.",
    "Top talent is off the market within 10 days, emphasizing the need for speed in hiring.",
    "Cultural fit is considered the most important factor by 82% of hiring managers.",
    "Blind recruitment can reduce hiring bias by up to 25% and improve diversity.",
    "The average recruiter spends only 6 seconds reviewing a resume before making a decision.",
    "Companies with structured interview processes are 2x more likely to make successful hires.",
    "Flexible working arrangements are the top priority for 88% of job seekers in 2024.",
    "AI-powered recruitment tools can reduce time-to-hire by up to 50%.",
    "71% of candidates want salary information included in job postings.",
    "Personalized candidate experiences can improve offer acceptance rates by 45%.",
    "Internal mobility programs can increase employee retention by 39%.",
    "The average cost-per-hire has increased by 20% in the last 5 years due to competitive markets.",
    "Companies that prioritize diversity in hiring see 19% higher revenue growth.",
    "60% of job seekers have quit applications due to their length or complexity.",
    "The most successful recruitment posts include emojis and have a conversational tone.",
    "Video job descriptions receive 12% more applications than text-only postings."
  ];
