...
export default function Startfromscratchleaderintroduction({
  isOpen,
  ...props
}) {
    ...
    <>
      <div className="container-sm flex justify-center rounded-[12px] border border-solid border-blue_gray-50_01 bg-white-A700 md:flex-col md:p-5">
        <div className="flex w-[41%] justify-center md:w-full sm:flex-col">
          ...
          <div className="flex flex-1 flex-col gap-[15px] border-r border-solid border-blue_gray-50 px-[31px] pb-8 pt-[31px] sm:self-stretch sm:p-5">
            <div className="flex flex-col gap-[31px]">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex justify-end rounded-lg border border-dashed border-blue_gray-100 bg-white-A700 pt-3">
                    <div className="flex w-[79%] items-start justify-between gap-5 md:w-full md:p-5">
                      ...
                      <div className="relative mt-[5px] h-[48px] w-[15%]">
