...
import Sidebar4 from "../../components/components/Sidebar4";

export default function Startfromscratchemployeetestimonialsmobile({
  isOpen,
  ...props
}) {
  return (
    <>
      <div className="container-sm flex justify-center rounded-[12px] border border-solid border-blue_gray-50_01 bg-white-A700 md:flex-col md:p-5">
        <Sidebar4 className="md:hidden md:gap-[30px] md:p-5 sm:pt-5" />
        <div className="flex flex-1 md:flex-col md:self-stretch">
          <div className="flex flex-1 flex-col gap-[137px] border-r border-solid border-blue_gray-50 px-[31px] pb-8 pt-[31px] md:gap-[102px] md:self-stretch sm:gap-[68px] sm:p-5">
          ...
          <div className="w-[37%] border-r border-solid border-blue_gray-50 pl-[26px] pt-[26px] md:w-full sm:pl-5 sm:pt-5">
