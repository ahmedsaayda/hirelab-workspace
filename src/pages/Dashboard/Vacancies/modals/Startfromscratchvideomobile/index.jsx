...
export default function Startfromscratchvideomobile({ isOpen, ...props }) {
  return (
    <>
      <div className="container-sm flex justify-center rounded-[12px] border border-solid border-blue_gray-50_01 bg-white-A700 md:flex-col md:p-5">
        <div className="flex flex-1 justify-center md:flex-col md:self-stretch">
          <Sidebar8 />
          <div className="flex flex-1 flex-col gap-[269px] border-r border-solid border-blue_gray-50 px-[31px] pb-8 pt-[31px] md:gap-[201px] md:self-stretch sm:gap-[134px] sm:p-5">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="rounded-lg border border-dashed border-blue_gray-100 bg-white-A700 pb-[5px] pl-3.5 pt-6 sm:pt-5">
                    <div className="flex items-start justify-between gap-5 pl-[245px] md:pl-5">
                    ...
                    <div className="flex flex-col gap-[31px]">
                      ...
                      <div className="flex flex-col items-end">
                        <div className="flex flex-col items-start self-stretch border-2 border-solid border-light_blue-A700 bg-white-A700">
                          ...
                          <div className="mt-[7px] flex w-[92%] flex-col gap-2 self-center bg-white-A700 px-4 py-6 md:w-full sm:py-5">
                            <div>
