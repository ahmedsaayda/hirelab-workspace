...
import { Button, Heading, Img, Input, Switch, Text } from "../../components/components";
import Sidebar8 from "../../components/components/Sidebar8";
...
export default function Startfromscratchvideo({ isOpen, ...props }) {
  return (
    <>
      <div className="container-sm flex justify-center rounded-[12px] border border-solid border-blue_gray-50_01 bg-white-A700 md:flex-col md:p-5">
              ...
              <div className="flex flex-col items-start gap-[31px]">
                ...
                <div className="flex flex-col gap-6 self-stretch">
                  ...
                  <div className="flex flex-col items-start gap-[9px]">
                    ...
                    <div className="flex justify-end self-stretch rounded-lg border border-dashed border-blue_gray-100 bg-white-A700 pb-[5px] pt-6 sm:pt-5">
        ...
        <div className="w-[59%] border-r border-solid border-blue_gray-50 pl-[25px] pr-2.5 pt-[25px] md:w-full sm:pl-5 sm:pt-5">
          <div className="flex flex-col gap-7">
            ...
            <div className="relative h-[734px] md:h-auto">
              <div className="w-[98%]">
                ...
                <div className="relative mt-[-4px] bg-gradient pb-[303px] pl-[746px] md:pb-5 md:pl-5">
                  <div className="h-[8px] w-[8px] border border-solid border-light_blue-A700 bg-white-A700" />
                </div>
              </div>
              <div className="absolute bottom-[35%] right-[0.00px] m-auto flex flex-col items-start gap-2">
                <Img
                  src="/images/img_save.svg"
                  alt="save"
                  className="h-[24px]"
                />
                <div className="flex self-end bg-light_blue-A700 shadow-lg">
                  <Text
                    size="5xl"
                    as="p"
              ...
              <div className="absolute bottom-[2.18px] left-0 right-0 m-auto flex w-[97%] flex-col gap-[54px] sm:gap-[27px]">
                ...
                <div className="flex rounded-[15px] bg-white-A700_f2 px-[30px] pt-[30px] md:flex-col sm:px-5 sm:pt-5">
                  <div className="flex w-[31%] flex-col items-start md:w-full">
                    ...
                    />
                    <Text size="xl" as="p" className="mt-[13px] !font-satoshi">
