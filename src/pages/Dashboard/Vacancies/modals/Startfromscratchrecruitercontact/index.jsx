...
export default function Startfromscratchrecruitercontact({ isOpen, ...props }) {
  return (
    <>
            ...
            <div className="flex flex-col gap-1.5">
              <div className="relative h-[475px]">
                <div className="absolute left-0 right-0 top-[0.00px] m-auto flex w-[97%] flex-col items-start border-2 border-solid border-light_blue-A700 bg-white-A700">
                  ...
                  <div className="ml-4 mt-[25px] flex items-center self-stretch bg-white-A700 p-6 md:ml-0 md:flex-col sm:p-5">
                    <div className="relative h-[317px] w-full md:h-auto">
                      <Img
                        src="/images/img_user.svg"
                        alt="user"
                        className="mr-[43px] mt-2.5 h-[95px] w-[95px] rounded-lg md:mr-0"
                      />
                      <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-max w-full items-center justify-center">
                        <Img
                          src="/images/img_polygon_2.svg"
                          alt="polygontwo"
                          className="relative z-[3] mb-[39px] h-[83px] w-[83px] self-end rounded-lg"
                        />
                        <Img
                          src="/images/img_mask_group_286x286.png"
                          alt="image"
                          className="relative ml-[-66px] h-[317px] w-[317px] object-cover"
                        />
                      </div>
                    </div>
                    <div className="flex w-full flex-col items-start gap-3">
                      <div className="flex flex-col gap-2 self-stretch">
                        ...
                        <div className="flex flex-col items-start gap-2.5">
                          <Heading size="md" as="h4" className="!text-[9.99px]">
                          ...
                          <Heading size="md" as="h5" className="!text-[9.99px]">
                            <span className="font-normal text-gray-900_01">
                              Title:&nbsp;
                            </span>
                            <span className="text-gray-900_01">
                          ...
                          <Heading size="md" as="h6" className="!text-[9.99px]">
                            <span className="font-normal text-gray-900_01">
                              Phone:&nbsp;
                            </span>
                            <span className="text-gray-900_01">
                          ...
                          <Heading size="md" as="p" className="!text-[9.99px]">
                            <span className="font-normal text-gray-900_01">
                              Email:&nbsp;
                            </span>
                            <span className="text-gray-900_01">
                  ...
                  <div className="mt-[26px] h-[3px] w-[5px] border border-solid border-light_blue-A700 bg-white-A700" />
                </div>
              ...
              <div className="relative h-[250px] md:h-auto">
                <div className="flex w-full flex-col gap-[54px] sm:gap-[27px]">
                  ...
                  <div className="flex rounded-[15px] bg-white-A700_f2 px-[30px] pt-[30px] md:flex-col sm:px-5 sm:pt-5">
                    ...
                    <div className="flex flex-1 gap-px md:flex-row md:self-stretch">
                      {data1.map((d, index) => (
                        ...
                        >
                          ...
                          <Heading as="p" className="mt-[13px]">
                            {d.company}
                          </Heading>
                          <Heading as="p" className="mt-[41px]">
                            {d.mission}
                          </Heading>
                ...
                <div className="absolute bottom-0 left-0 right-0 top-0 m-auto h-[250px] w-full rotate-[180deg] bg-gradient" />
              </div>
            </div>
          </div>
        </div>
