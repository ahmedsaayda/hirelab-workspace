...
import Sidebar11 from "../../components/components/Sidebar11";
import StartFromScratchJobDescriptionColumnsalary from "../../components/components/StartFromScratchJobDescriptionColumnsalary";
...
export default function Startfromscratchjobdescription({ isOpen, ...props }) {
  return (
    <>
      <div className="container-sm flex justify-center rounded-[12px] border border-solid border-blue_gray-50_01 bg-white-A700 md:flex-col md:p-5">
        <div className="flex w-[41%] justify-center md:w-full sm:flex-col">
          <Sidebar11 />
          <div className="flex flex-1 flex-col gap-[149px] border-r border-solid border-blue_gray-50 px-[30px] pb-8 pt-[30px] md:gap-[111px] sm:gap-[74px] sm:self-stretch sm:p-5">
        ...
        <div className="w-[59%] border-r border-solid border-blue_gray-50 pl-[25px] pr-2.5 pt-[25px] md:w-full sm:pl-5 sm:pt-5">
          <div className="flex flex-col gap-[31px]">
            ...
            <div className="flex flex-col gap-[111px] md:gap-[83px] sm:gap-[55px]">
              <div className="relative h-[732px]">
                ...
                <div className="absolute bottom-[13%] right-[0.00px] m-auto flex w-[19%] flex-col items-end gap-2">
                ...
                <div className="absolute bottom-[0.00px] left-0 right-0 m-auto w-[97%]">
                  <div className="relative z-[3] h-[103px] rotate-[180deg] bg-gradient" />
                  <div className="relative mt-[-88px] flex gap-[30px] md:flex-col">
                    {data1.map((d, index) => (
                      <StartFromScratchJobDescriptionColumnsalary
                        {...d}
