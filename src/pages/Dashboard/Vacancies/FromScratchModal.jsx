...
const getAiPromptContent = (userData) => {
  console.log("userData", userData);
  return `Create an vacancy landing page according to this vacancy data. Use EVP framework to create the most awesome job page. Improvise if required information is missing. It is important to translate the content of the page accurately, especially when it comes to benefits, tasks and responsibilities.
The content of the landing page (including the form) should have the same language from the provided vacancy data.
IMPORTANT - Company Information (from website scrape):
${userData?.companyInfo}
## here is more information about the user and the company:
${JSON.stringify(userData)}
Please respond with the barebone Json object of the vacancy landing page that follow the following the schema in the exemple and the rules rules:
##schema:${JSON.stringify(VacacnySchema)}.
##rules:${JSON.stringify(AiRules)}.`;
};

const aiSchem = {
  vacancyTitle: { type: String, default: "", maxLength: 40 },

  heroDescription: {
    type: String,
    default:
      "Write a catchy description for the vacancy based on the vacancy data provided.",
    maxLength: 120,
  },
  ...
  companyFacts: {
    type: [
      {
        descriptionText: { type: String, default: "", maxLength: 80 },
        headingText: { type: String, default: "", maxLength: 25 },
        icon: {
          type: String,
          default: "lucide-react:bar-chart-square",
        },
      },
    ],
    default: [],
  ...
  recruiterContactText: { type: String, default: "", maxLength: 120 },

  specifications: [
    {
      title: { type: String, default: "Benefits", maxLength: 20 },
      description: {
        type: String,
        default: "Benefits description",
        maxLength: 40,
      },
      icon: { type: String, default: "" },
      bulletPoints: [
        {
          bullet: { type: String, default: "", maxLength: 100 },
        },
      ],
    },
  ],
  ...
  agendaDescription: {
    type: String,
    default: "Take a glimpse of how your agenda might look like.",
    maxLength: 120,
  },
  jobDescriptionTitle: {
    type: String,
    default: "About the job",
    maxLength: 40,
  },
  ...
  jobDescription: {
    type: String,
    default:
      "You will assist in the planning, execution, and optimization of marketing initiatives to promote our products and services. This role will collaborate with various teams to develop and implement marketing campaigns across multiple channels. Coordinate and execute marketing campaigns, including email, social media, and digital advertising. Assist in the creation of marketing materials, such as brochures, presentations, and advertisements. Monitor and analyze the performance of marketing campaigns, providing insights and recommendations for improvement.",
    maxLength: 2000,
  },
  ...
  dailyScheduleList: {
    ...
    default: [
      ...
      { timeSlot: "13:00 - 14:00", dateSlot: {}, eventTitle: "Lunch Break" },
      {
...
const defaultBuidup = [
    ...
    fields: [
      {
        ...
        notes: `
      No ai for this , we use what the user already provided in the job title field
      `,
        max: 40,
      },
      {
        ...
        notes: `
      should be ai populated / enhanced with the job description
      `,
        max: 120,
      },
      {
        fieldName: "location",
        notes: `
      ai should populate this to not break the design
      `,
      },
    ],
  },
  {
    ...
    fields: [
      {
        fieldName: "jobSpecificationTitle",
        notes: `
      ...
      {
        fieldName: "jobSpecificationDescription",
        notes: `
        Ai generated / enhanced
        `,
        max: 120,
  ...
  },
  {
    ...
    fields: [
      {
        fieldName: "recruiterContactTitle",
        notes: `
        Ai generated / enhanced
        `,
        max: 40,
      ...
      {
        fieldName: "recruiterContactText",
        notes: `
        Ai generated / enhanced
        `,
        max: 120,
      },
      {
        ...
        notes: `
        Ai don't fill this section , we will populate one item with the user object after crudService.create
        `,
      },
    ],
  },
  {
    ...
    fields: [
      {
        fieldName: "jobDescriptionTitle",
        notes: `
        Ai generated / enhanced
        `,
      },
      {
        fieldName: "jobDescriptionSubheader",
        notes: `
        Ai generated / enhanced
        `,
        max: 40,
  ...
  },
  {
    ...
    fields: [
      ...
      {
        fieldName: "companyFactsDescription",
        notes: `
        Ai generated / enhanced
        `,
        max: 120,
      ...
      {
        fieldName: "companyFacts",
        notes: `
        Ai generated / enhanced
        max 6 items
        Ai should populate the icon, headingText, descriptionText
        for icons we use lucide-react icons ( ai must select from a valid lucide icon )
        `,
      },
    ],
  },
  {
    ...
    fields: [
      //aboutTheCompanyTitle , aboutTheCompanyText , aboutTheCompanyDescription
      {
        fieldName: "aboutTheCompanyTitle",
        notes: `
        Ai generated / enhanced
        `,
        max: 40,
      ...
      {
        fieldName: "aboutTheCompanyDescription",
        notes: `
        Ai generated / enhanced
        `,
        max: 500,
...
const defaultBuidupSectionsStrings = [
  "header",
  "Job Specifications",
  "Recruiter contact",
  "Job description",
