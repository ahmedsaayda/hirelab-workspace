    ...
    <>
              ...
              {me?.KYCProcess?.last_error?.reason && (
                <div className="mt-2 text-sm text-indigo-500">
                  ...
                  <p>
                    ...
                    <a href={`mailto:${partner?.primaryContact}`}>
                      customer support
                    </a>
                    .
                  </p>
      ...
      <div className="text-center mt-10">
        ...
        <div className="mt-6">
          <button
            type="button"
            className="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm dark:shadow-gray-400/50  hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            onClick={handleStart}
          >
            Get started
          </button>
