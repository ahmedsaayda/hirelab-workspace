...
export default function Startfromscratchcandidateprocessmobile({
  isOpen,
  ...props
}) {
  return (
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex gap-5 md:flex-col">
              <Input
                ...
                name="button_one"
                placeholder={`Back`}
                className="w-full border border-solid border-blue_gray-100 font-semibold !text-blue_gray-800 sm:px-5"
              />
              <Button
                shape="round"
