...
export default function Sidebar10({ ...props }) {
  ...
  return (
    <Sidebar
      ...
      className={`${props.className} flex flex-col h-screen pt-[33px] gap-[30px] top-0 px-4 mdx:p-5 smx:pt-5 border-blue_gray-50 border-r border-solid bg-white-A700 !sticky overflow-auto mdx:hidden`}
    >
      ...
      >
        ...
        <MenuItem
          icon={
            <Img
              src="/images/img_message_chat_circle_light_blue_a700.svg"
              alt="messagechat"
              className="h-[18px] w-[18px]"
            />
          }
