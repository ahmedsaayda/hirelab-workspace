    ...
    <>
      ...
      <div>
        ...
        <div className="lg:pl-72">
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 dark:border-gray-600  dark:border-gray-600 bg-white dark:bg-gray-900 px-4 shadow-sm dark:shadow-gray-400/50  sm:gap-x-6 sm:px-6 lg:px-8">
            {loading && <Spin />}
            <button
              type="button"
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              <form className="relative flex flex-1" action="#" method="GET">
                ...
                <input
                  id="search-field"
                  className="block h-full w-full border-0 py-0 pl-8 pr-0 text-gray-900 dark:text-gray-400  placeholder:text-gray-400 focus:ring-0 sm:text-sm dark:bg-gray-900"
                  placeholder="Search..."
                  type="search"
                /> */}
              </form>
              <div className="flex items-center gap-x-4 lg:gap-x-6">
                ...
                <Menu as="div" className="relative">
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-40 mt-2.5 w-48 origin-top-right rounded-md bg-white dark:bg-gray-900 py-2 shadow-lg dark:shadow-gray-400/50 hover:shadow-gray-600/50  ring-1 ring-gray-900/5 focus:outline-none">
